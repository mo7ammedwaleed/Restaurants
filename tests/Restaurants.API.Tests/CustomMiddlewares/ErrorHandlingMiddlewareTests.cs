...
namespace Restaurants.API.CustomMiddlewares.Tests;
...
public class ErrorHandlingMiddlewareTests
{
    ...
    [Fact()]
    public async Task InvokeAsync_WhenForbiddenExceptionThrown_ShouldSetStautsCodeTo403()
    {
        // Arrange
    ...
    [Fact()]
    public async Task InvokeAsync_WhenGenericExceptionThrown_ShouldSetStautsCodeTo500()
    {
        // Arrange
